export default function VideoItem(props) {
  ...
  return (
    <>
      <a href={link}>
        <div className="inline-flex mt-4 px-3 py-2 pr-6 -ml-2 mb-2 bg-gray-300 items-center hover:cursor-pointer rounded-lg dark:bg-black">
        <p className="font-sans hyphen-auto text-gray-900 dark:text-gray-400">
          ...
          <span className="leading-loose pt-2">{text}</span>
        </p>
        </div>
      </a>
    </>
