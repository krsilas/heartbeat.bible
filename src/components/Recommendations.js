...
export default () => {
    ...
    return (
        <div className={`my-12 mx-5 transition-slower transition-opacity text-gray-900 ${scrollPosition < 30 ? 'opacity-50' : null}`}>
        ...
        <Item title="Sein Wort - meine Welt: Die Studienbibel für das 21. Jahrhundert" img="elb-studienbibel.png" href="https://www.amazon.de/Sein-Wort-meine-Studienbibel-Jahrhundert/dp/3417255430/" type="book" />
				...
				<h4 className="mt-8 mb-2 text-sm uppercase text-gray-700 dark:text-gray-400 font-semibold tracking-wider">Podcasts</h4>
        <Item type="podcast" title="Knowing Faith" subtitle="The Village Church Dallas" img="knowing_faith.jpg" href="https://plinkhq.com/i/1274228164?to=page"/>
				...
				<h4 className="mt-8 mb-2 text-sm uppercase text-gray-700 dark:text-gray-400 font-semibold tracking-wider">Apps</h4>
        <Item type="app" title="Bibel (YouVersion)" subtitle="Life.Church" img="youversion.png" />
				<Item type="app" title="Blueletter Bible" subtitle="In-Depth Study Bible" img="blue_letter_bible.png" />

				<h4 className="mt-8 mb-2 text-sm uppercase text-gray-700 dark:text-gray-400 font-semibold tracking-wider">Youtube</h4>
...
const Item = (props) => {
    ...
    return (
        ...
        <div className="flex text-gray-800 items-center px-2 py-2 bg-gray-200 dark:bg-gray-900 dark:border-gray-800 border-gray-300 border rounded-lg my-2">
						{ type == 'book'
						? <img className="book h-16 w-auto m-1 mr-2" src={imageUrl(img)} width="100" height="100" alt="Image"/>
						: <img className="h-16 w-auto m-1 mr-3 rounded" src={imageUrl(img)} width="100" height="100" alt="Image"/> }
            
            <div className="py-1 flex-grow dark:text-gray-500">
                <h4 className="font-medium leading-tight pb-1">{title}</h4>
                <p className="font-light text-gray-800 opacity-75 text-sm">{subtitle}</p>
            </div>
