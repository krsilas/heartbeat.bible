...
const Item = (props) => {
    ...
    return (
        <a href={href} target="_blank" rel="noopener norefferer" className="flex text-gray-800 items-center px-2 py-2 bg-gray-200 dark:bg-gray-900 dark:border-gray-800 border-gray-300 border rounded-lg my-2">
						{ type == 'book'
